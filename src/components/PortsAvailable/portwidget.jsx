export default function PortWidget({ipAddress,macAddress,range,handleClick}){
    return (
        <>
        <div className="h-22 min-w-80 rounded-lg shadow-md bg-lightComponentBackground dark:bg-darkComponentBackground flex flex-grow-1 p-4 justify-between border-2 border-white" onClick={()=>handleClick(ipAddress)}>
