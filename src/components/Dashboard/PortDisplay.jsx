    ...
    return (
        <>
            <div ref={modalRef} className="fixed inset-0 bg-black/30 backdrop-blur-sm flex justify-center items-center z-50" onClick={closeRef}>
                <div className="h-[62%] lg:h-[55%] w-[90%] lg:w-[55%] flex flex-col bg-lightComponentBackground dark:bg-darkComponentBackground rounded-2xl shadow-md p-4 lg:px-8 pt-4">
                    {/* Heading */}
